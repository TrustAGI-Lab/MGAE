...
% OUTPUT:
    ...
    fprintf('F:   ');
    for i=1:numiter+2
        fprintf('%.3f(%.3f)  ', F(i), std_F(i));
    end
    fprintf('\n\n');
    fprintf('P:   ');    
    for i=1:numiter+2      
        fprintf('%.3f(%.3f)  ', P(i), std_P(i));
    end
    fprintf('\n\n');
    fprintf('R:   ');    
    for i=1:numiter+2      
        fprintf('%.3f(%.3f)  ', R(i), std_R(i));
    end
    fprintf('\n\n');
    fprintf('nmi:   ');    
    for i=1:numiter+2      
        fprintf('%.3f(%.3f)  ', nmi(i), std_nmi(i));
    end
    fprintf('\n\n');
    fprintf('avgent:   ');    
    for i=1:numiter+2      
        fprintf('%.3f(%.3f)  ', avgent(i), std_avgent(i));
    end
    fprintf('\n\n');
    fprintf('AR:   ');    
    for i=1:numiter+2      
        fprintf('%.3f(%.3f)  ', AR(i), std_AR(i));
    end
    fprintf('\n\n');
    for j=1:num_views
